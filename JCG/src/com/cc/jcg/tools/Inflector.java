...
/*
 * JBoss DNA (http://www.jboss.org/dna) See the COPYRIGHT.txt file distributed with this work for information regarding copyright ownership. Some portions may be licensed to Red Hat, Inc. under one or more contributor license agreements. See the AUTHORS.txt file in the distribution for a full
 * listing of individual contributors. JBoss DNA is free software. Unless otherwise indicated, all code in JBoss DNA is licensed to you under the terms of the GNU Lesser General Public License as published by the Free Software Foundation; either version 2.1 of the License, or (at your option) any
 * later version. JBoss DNA is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public License for more details. You should have received a copy of the GNU
 * Lesser General Public License along with this software; if not, write to the Free Software Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA 02110-1301 USA, or see the FSF site: http://www.fsf.org.
 */
...
/**
 * Transforms words to singular, plural, humanized (human readable), underscore, camel case, or ordinal form. This is inspired by the <a href="http://api.rubyonrails.org/classes/Inflector.html">Inflector</a> class in <a href="http://www.rubyonrails.org">Ruby on Rails</a>, which is distributed under
 * the <a href="http://wiki.rubyonrails.org/rails/pages/License">Rails license</a>.
 *
...
public class Inflector {
    ...
    /**
     * By default, this method converts strings to UpperCamelCase. If the <code>uppercaseFirstLetter</code> argument to false, then this method produces lowerCamelCase. This method will also use any extra delimiter characters to identify word boundaries. Examples:
     *
     * <pre>
    ...
    /**
     * Makes an underscored form from the expression in the string (the reverse of the {@link #camelCase(String, boolean, char[]) camelCase} method. Also changes any characters that match the supplied delimiters into underscore. Examples:
     *
     * <pre>
    ...
    /**
     * Capitalizes the first word and turns underscores into spaces and strips trailing "_id" and any supplied removable tokens. Like {@link #titleCase(String, String[])}, this is meant for creating pretty output. Examples:
     *
     * <pre>
    ...
    /**
     * Capitalizes all the words and replaces some characters in the string to create a nicer looking title. Underscores are changed to spaces, a trailing "_id" is removed, and any of the supplied tokens are removed. Like {@link #humanize(String, String[])}, this is meant for creating pretty output.
     * Examples:
     *
     * <pre>
    ...
    /**
     * Utility method to replace all occurrences given by the specific backreference with its uppercased form, and remove all other backreferences. The Java {@link Pattern regular expression processing} does not use the preprocessing directives <code>\l</code>, <code>&#92;u</code>, <code>\L</code>,
     * and <code>\U</code>. If so, such directives could be used in the replacement string to uppercase or lowercase the backreferences. For example, <code>\L1</code> would lowercase the first backreference, and <code>&#92;u3</code> would uppercase the 3rd backreference.
     *
     * @param input
     * @param regex
